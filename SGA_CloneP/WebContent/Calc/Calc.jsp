...
// 	   }
	...
	function Check() {
	      ...
	      if(value<=100 || value>=250 || value==null || value2<=0 || value2>=250 || value2==null){ // 예외처리
	...
	<form action="${pageContext.request.contextPath}/Calc/BmiResult.jsp" onsubmit="return Check();"
      ...
      <table>
         <tr>
            ...
            <td>
               <button id="maker" name="maker" style="width:100px; height:80px;"class="btn btn-outline-dark" onClick="alert('만든이 : \n이수진 정한결 최동오')">Maker</button>
            </td>
         </tr>
      </table>
      <table>
