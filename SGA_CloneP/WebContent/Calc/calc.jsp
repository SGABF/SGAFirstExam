...
<script type="text/javascript">
	...
	//더하기 빼기
	function add() {
	    var num1 = document.getElementById("heightbar"); 
		var add = parseInt(num1.value) +1 
  ...
  function minus() {
	    var num1 = document.getElementById("heightbar");
	    var minus = parseInt(num1.value) -1
	
	    heightbar.value = minus;
	...
	<form action="${pageContext.request.contextPath}/Calc/BmiResult.jsp" method="post">
		<table>
			...
			<tr>
				...
				<td><input type="button" value="한글자삭제" id="c" name="c" onClick="Clearleft()"/></td>
			...
			<tr>
				...
				<td><input type="button" value="+" id="+" name="+" onClick="add(this.id)"/></td>
			</tr>
			<tr>
				...
				<td><input type="button" value="-" id="-" name="-" onClick="minus(this.id)"/></td>
			</tr>
			<tr>
